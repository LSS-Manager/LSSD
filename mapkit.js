/* Copyright © 2015-2018 Apple Inc. All rights reserved. */ ! function() {
    function t(e, i, n) {
        function o(a, r) {
            if (!i[a]) {
                if (!e[a]) {
    ...
    1: [function(t, e, i) {
        (function(i) {
            var n = t("@maps/localizer"),
                ...
                l = o.isIE9() || o.isIE10() ? window.location.protocol : "https:",
                h = {
                ...
                f = {
                    ...
                    appendAuthOptions: function(t, e) {
                        return this.origin && (t.origin = this.origin), this.authorizationCallback && (t.headers = {
                            Authorization: o.fillTemplate("Bearer {{token}}", {
                    ...
                    _loadFromServer: function(t) {
                        if (this._bootstrapRequestParams = {
                            ...
                            this.authorizationCallback(function(t) {
                                this.appendAuthOptions(i, t), this.accessToken && (i.headers["X-Maps-Access-Token"] = o.fillTemplate("Bearer {{token}}", {
                                    token: this.accessToken
                                })), new a(e, this, i).schedule()
                            }.bind(this))
                        }
                    },
    ...
    4: [function(t, e, i) {
        ...
        "../../lib/geo": 2,
        "../../src/js/annotations/marker-annotation": 144,
        "../../src/js/collections/item-collection": 156,
        "../../src/js/overlays/polygon-overlay": 197,
        "../../src/js/overlays/polyline-overlay": 200,
        "./constants": 3,
        "./validate": 6
    }],
    5: [function(t, e, i) {
    ...
    8: [function(t, e, i) {
        ...
        n.Themes = {
            Light: {
                fillColor: [249, 245, 237],
                lineColor: [152, 151, 147]
            },
            Dark: {
                fillColor: [64, 64, 64],
    ...
    14: [function(t, e, i) {
        ...
        n.prototype = {
            ...
            get canTrustGestureCenter() {
                return !(o.supportsGestureEvents && !o.supportsTouches && o.insideIframe)
            },
            ...
            centerForGesture: function(t) {
                var e = this.map;
                return e.staysCenteredDuringZoom || !this.canTrustGestureCenter ? e.transformCenter : this._centerWithRecognizer(t)
            },
            destroy: function() {
    ...
    19: [function(t, e, i) {
        ...
        n.prototype = {
            ...
            initRenderer: function(t, e, i) {
                var n = this._syrupRenderer = new t({
                    startInLoCSR: i
                });
    ...
    20: [function(t, e, i) {
        ...
        n.prototype = r.inheritPrototype(l, n, {
            ...
            _startDeceleratingWithVelocity: function(t) {
                if (Math.abs(t) > 1440) this.map.cameraDidStopRotating();
                else {
    ...
    22: [function(t, e, i) {
        function n() {
            o.call(this), Object.defineProperty(this, "_impl", {
                value: new s(this)
            })
        }
    ...
    24: [function(t, e, i) {
        ...
        var o = t("./base-map-node-internal"),
            ...
            r = t("@maps/js-utils"),
            l = t("./rotation-controller"),
            h = t("./initial-interaction-controller");
        n.prototype = r.inheritPrototype(o, n, {
            init: function(t, e, i, n, o) {
            ...
            set isRotationEnabled(t) {
                !t && this._rotationController ? (this._rotationController.destroy(), delete this._rotationController) : t && !this._rotationController && (this._initialInteractionController || (this._initialInteractionController = new h(this)), this._rotationController = new l(this), this.camera._initialRotation = 0), this._isRotationEnabled = t
            },
            get rotation() {
    ...
    25: [function(t, e, i) {
        function n() {
            o.call(this), this._renderer = new s(this), Object.defineProperty(this, "_impl", {
                value: new a(this)
            })
        }
        var o = t("./base-map-node"),
                ...
                if (this._canDraw()) {
                    ...
                    for (var m = e.zoom, g = t.visibleMapRect, _ = g.origin, f = g.size, y = 0, v = this.children, w = v.length; y < w; ++y) {
                        var b = v[y],
                            ...
                            L = C.mapRect.origin,
                            E = Math.pow(2, m - S),
                            T = Math.pow(2, S) * (o.tileSize * E),
                            x = L.x - _.x;
                        x > f.width ? x-- : x + C.mapRect.size.width < 0 && x++, b.scale = E, b.position = new a.Point(r.roundToDevicePixel(x * T), r.roundToDevicePixel((L.y - _.y) * T)), y < w - 1 && C.cancel()
                    }
        ...
        n.prototype = r.inheritPrototype(c, n, {
            ...
            _handleWheelEvent: function(t) {
                if (t.shiftKey && !t.ctrlKey) {
                    ...
                    this._lastCentroid = o, this._lastScaleCenter = this._mapPointFromCentroid(o);
                    var s = n.camera.zoom;
    ...
    53: [function(t, e, i) {
        ...
        function s(t) {
            n.call(this, t), ["center", "mass", "stiffness", "damping", "initialVelocity"].forEach(function(e) {
                e in t && (this[e] = t[e])
            }, this), this.mass > 0 && (this.springSolver = new a(this.mass, this.stiffness, this.damping, this.initialVelocity))
        }
        ...
        n.prototype = {
            ...
            begin: function() {
                return this.beginDate = Date.now(), h.scheduleASAP(this), this
            },
            performScheduledUpdate: function() {
                this.beginDate && (this._p = Math.min((Date.now() - this.beginDate) / this.duration, 1), this.update(this._p), this._p < 1 ? h.scheduleOnNextFrame(this) : this.ended())
            },
            ended: function() {
        ...
        }, o.prototype = c.inheritPrototype(n, o, {
            update: function(t) {
        ...
        }), s.prototype = c.inheritPrototype(n, s, {
            center: new r(0, 0),
            scale: function(t) {
                var e = this.center.x,
                    i = this.center.y;
                this.node.transform = (new l).translate(e, i).scale(t).translate(-e, -i)
            },
            update: function(t) {
    ...
    73: [function(t, e, i) {
        ...
        n.SupportsTouches = "createTouch" in document, n.SupportsGestures = !!window.GestureEvent, n.States = {
            ...
            meta: !1,
            shift: !1
        }, n.prototype.reset = function() {}, n.prototype.locationInElement = function(t) {
        ...
        }, n.prototype.touchesMoved = function(t) {}, n.prototype.touchesEnded = function(t) {}, n.prototype.touchesCancelled = function(t) {}, n.prototype.gestureBegan = function(t) {
        ...
        }, n.prototype.gestureChanged = function(t) {}, n.prototype.gestureEnded = function(t) {}, n.prototype.enterPossibleState = function() {
                    ...
                    if (t.type !== n.Events.TouchStart)
                        if (t.type !== n.Events.TouchMove) {
                            ...
                            for (var r = t.touches, o = 0, s = r.length; o < s; ++o) {
                                var l = r[o]; - 1 !== a.indexOf(l.identifier) && this._targetTouches.push(l)
                            }
                        }
                else {
                    this._targetTouches = [];
    ...
    93: [function(t, e, i) {
        ...
        "./lib/l10n": 94,
        "./lib/lang-tag": 95,
        "./lib/language-support": 96,
        "./lib/locale": 97,
        "./lib/localize-digits": 98,
        "./lib/use-metric": 99
    }],
    94: [function(t, e, i) {
        "use strict";
    ...
    100: [function(t, e, i) {
        ...
        function o(t, e) {
            e ? (d(T, t), S.scheduleDraw(s)) : p(T, t)
        }

        function s() {
            T.forEach(a), T = [], x.forEach(r), x = [], n.updates++, O.dispatchEvent(new v.Event(A))
        }
        ...
        function l(t, e) {
            ...
            switch (e) {
                ...
                case "position":
                case "transform":
                    var o = (new C).translate(E.roundToDevicePixel(t._position.x), E.roundToDevicePixel(t._position.y)).transform(t._transform);
        ...
        "@maps/device-pixel-ratio": 61,
        "@maps/dom-events": 62,
        "@maps/geometry/point": 101,
        "@maps/geometry/size": 102,
        "@maps/scheduler": 104,
        "@maps/web-point-converter": 105
    }],
    101: [function(t, e, i) {
    ...
    104: [function(t, e, i) {
        ...
        "@maps/request-animation-frame": 103
    }],
    105: [function(t, e, i) {
        arguments[4][83][0].apply(i, arguments)
    }, {
        "@maps/css-matrix": 106,
        "@maps/geometry/point": 107,
        dup: 83
    }],
    106: [function(t, e, i) {
        arguments[4][58][0].apply(i, arguments)
    ...
    109: [function(t, e, i) {
        e.exports = {
            version: "5.0.0",
            build: "18.17-93",
            cdnUrl: "//cdn.apple-mapkit.com/mk/5.0.0"
        }
    }, {}],
    110: [function(t, e, i) {
        function n() {
        ...
        function o() {
            return /\.apple\.com$/.test(window.origin) || /\.icloud\.com$/.test(window.origin) || /\.filemaker\.com$/.test(window.origin) || /\.apple-mapkit\.com$/.test(window.origin) || /\.tryrating\.com$/.test(window.origin)
        }
        var s = t("../configuration"),
            ...
            u = {
                Short: [c.ScreenSize, c.BrowserInfo, c.ApplicationIdentifier, c.BrowserWindowSize, c.Url, c.MapView, c.UserSession, c.Tile]
            },
            d = {
                Zoom: {
                    name: "ZOOM",
        ...
        n.prototype = {
            ...
            _configurationBecameAvailable: function() {
                s.analytics && (this._analyticsUrl = s.analytics.analyticsUrl)
            }
        }, e.exports = new n
    }, {
        "../configuration": 157,
    ...
    111: [function(t, e, i) {
        ...
        e.exports = function(t) {
            ...
            return t._isInternalClient || (e.host = t.reduceHost(location.host)), e
        }
    }, {
        "../../../build.json": 109
    }],
    112: [function(t, e, i) {
        e.exports = function(t) {
            ...
            return t._isInternalClient ? (e.browser_referer = document.referrer, e.browser_origin = location.origin) : e.browser_origin = t.reduceHost(location.origin), e
        }
    }, {}],
    113: [function(t, e, i) {
        e.exports = function() {
    ...
    114: [function(t, e, i) {
        ...
        "./application-identifier": 111,
        "./browser-info-state": 112,
        "./browser-window-size-state": 113,
        "./map-view-state": 115,
        "./screen-size-state": 116,
        "./tile-state": 117,
        "./url-state": 118,
        "./user-session-state": 119
    }],
    115: [function(t, e, i) {
        e.exports = function(t, e) {
    ...
    116: [function(t, e, i) {
        e.exports = function() {
            return {
                ...
                device_pixel_ratio: t("@maps/device-pixel-ratio")()
            }
        }
    }, {
        "@maps/device-pixel-ratio": 61
    ...
    117: [function(t, e, i) {
        e.exports = function(t, e) {
            return {
                rendering: e.map._mapNodeController && e.map._mapNodeController.usingSSR ? "SERVER" : "CLIENT"
            }
        }
    }, {}],
    118: [function(t, e, i) {
    ...
    122: [function(t, e, i) {
        function n(t, e, i, n) {
            o.call(this, t), m.EventTarget(t), p.checkType(i, "function"), p.checkOptions(n), this.coordinate = e;
            var a = i(e, n);
            p.checkElement(a, "[MapKit] Annotation element factory must return a DOM element, got `" + a + "` instead."), this._element = a, this._node = new g.Node(d.htmlElement("div", a)), this._node.wantsHardwareCompositing = !0, this._node.element._annotation = this, this._unsized = !0, this._public = t, this.occluded = !1, this._dragController || (this._dragController = new s(this)), n && (f.forEach(function(t) {
                t in n && (this[t] = n[t])
            ...
            }, this)), _.addEventListener(_.Events.LocaleChanged, this), this.updateLocalizedText()
        }
        var o = t("./annotation-layer-item-internal"),
            ...
            _ = t("../localizer").l10n,
            f = ["title", "subtitle", "data", "accessibilityLabel", "anchorOffset", "calloutOffset", "size", "visible", "enabled", "selected", "calloutEnabled", "animates", "callout", "appearanceAnimation", "draggable", "displayPriority", "collisionMode", "clusteringIdentifier"],
            y = n.Events = {
        ...
        n.prototype = p.inheritPrototype(o, n, {
            ...
            set collisionMode(t) {
                if (!p.checkValueIsInEnum(t, w)) throw new Error("[MapKit] Unknown value for `collisionMode`. Choose from Annotation.CollisionMode.");
            ...
            removedFromMap: function() {
                this._removedFromMap = !0, _.removeEventListener(_.Events.LocaleChanged, this)
            },
            addedToMap: function() {
                this._removedFromMap && (this._removedFromMap = !1, _.addEventListener(_.Events.LocaleChanged, this), this.updateLocalizedText())
            },
            delegate: null,
            ...
            draggingDidStart: function() {
                this._public.dispatchEvent(new m.Event(y.DragStart))
            },
            ...
            lift: function(t) {
                this._isLifted = !0, this._dragController.lift(t)
            },
            ...
            isDrawn: function() {
                return !this.occluded && this.mayBeDrawn()
            },
            dragOffset: u.Zero,
            handleEvent: function(t) {
                switch (t.type) {
            ...
            altText: function() {
                return this._accessibilityLabel || (this.title && this.subtitle ? _.get("Annotation.Generic.AccessibilityLabel", {
                    title: this.title,
            ...
            droppedAfterLift: function() {
                delete this._isLifted, this.selected && this.delegate.selectedAnnotationDidMoveToMap(this._public)
            },
        ...
        "../localizer": 180,
        "../utils": 223,
        "./annotation-drag-controller": 120,
        "./annotation-layer-item-internal": 123,
        "@maps/css-matrix": 58,
        "@maps/css-transform": 60,
        "@maps/dom-events": 62,
        "@maps/geometry/point": 69,
    ...
    123: [function(t, e, i) {
        ...
        n.CalloutTailSide = {
            ...
            _updateVisibility: function() {
                !this._visible && this._animating || (this.updateVisibility(!this._visible), this.delegate && this.delegate.annotationPropertyDidChange(this._public, "visible"))
            }
        }, e.exports = n
    }, {
        "../utils": 223,
    ...
    125: [function(t, e, i) {
        ...
        "./annotation-internal": 122,
        "./annotation-layer-item": 124,
        "@maps/js-utils": 84
    }],
    126: [function(t, e, i) {
        function n() {
    ...
    127: [function(t, e, i) {
        function n(t) {
            h.call(this, t), this._sceneGraphNode = new c, this._node = new C.Node(y.htmlElement("div", {
                class: L.CONTAINER
            })), this._annotationsNode = this._node.addChild(new C.Node(this._sceneGraphNode.element)), this._calloutsNode = this._node.addChild(new C.Node(y.htmlElement("div"))), this._styleHelper = new g, this._map.element.appendChild(this._styleHelper.element), this._pendingAnnotations = [], this._annotationDraggingMapPanningController = new r(t), this._clustersController = new l(this)
        }
        ...
        var a = t("../../../lib/geo"),
            ...
            p = t("./callout"),
            m = t("../services/geocoder"),
            g = t("../style-helper"),
            _ = a.MapRect,
            f = t("./user-location-annotation"),
            y = t("../utils"),
            v = t("@maps/js-utils"),
            w = t("@maps/geometry/point"),
            b = t("@maps/geometry/rect"),
            C = t("@maps/render-tree"),
            S = t("@maps/scheduler"),
            L = {
            ...
            E = null;
        n.prototype = v.inheritPrototype(h, n, {
            itemConstructor: u,
            itemName: "annotation",
            ...
            addWaitingAnnotations: function(t) {
                ...
                }, this), delete this._waitingAnnotations, S.scheduleOnNextFrame(this._checkCompletion.bind(this))) : e && t()
            },
            annotationsInMapRect: function(t) {
                v.checkInstance(t, _, "[MapKit] Map.annotationsInMapRect expects a MapRect as its argument, got `" + t + "` instead.");
            ...
            removeItem: function(t) {
                return t === this._userLocationAnnotation ? (console.warn("[MapKit] Map.removeAnnotation: the user location annotation cannot be removed. Set showsUserLocation to false instead."), t) : h.prototype.removeItem.call(this, t)
            },
            ...
            updateUserLocationAnnotation: function(t) {
                if (t.coordinate) {
                    var e = this._userLocationAnnotation || new f(t);
                    ...
                    this._lastGeocoderRequestCoordinate = e._impl.coordinate.copy(), T(E, e, this)
                }
            },
            ...
            startDraggingAnnotation: function(t, e) {
                this._map.annotationDraggingWillStart(), this._draggedAnnotation = t, this._pendingDragStart = !0, t.selected && this._hideCallout(t), y.classList.add(this._node.element, L.DRAGGING), y.classList.add(this._draggedAnnotation._impl.node.element, L.LIFTED), this._draggedAnnotation._impl.lift(40), this._updateSceneGraph()
            },
            handleEvent: function(t) {
                switch (t.type) {
            ...
            removedItem: function(t) {
                t._impl.node.remove(), h.prototype.removedItem.call(this, t), t._impl.labelRegion && (this._map.unregisterLabelRegion(t._impl.labelRegion), delete t._impl.labelRegion), this._updateVisibleAnnotations([t]), this._clustersController.removedAnnotation(t), t.memberAnnotations || this._updateCollisions(this._items)
            },
            ...
            annotationDraggingDidChange: function(t) {
                this._draggedAnnotation && !this._draggedAnnotation._impl.shouldPreventDrag && (this._pendingDragStart && (delete this._pendingDragStart, this._draggedAnnotation._impl.draggingDidStart(), this._map.dispatchEventWithAnnotation(d.Events.DragStart, this._draggedAnnotation)), S.scheduleASAP(this), this._draggedAnnotation._impl.setDraggingTranslationForMapFrameSize(t, this._map.ensureRenderingFrame().size), this._annotationDraggingMapPanningController.update(this._draggedAnnotation, this._draggedAnnotation._impl.node))
            },
            annotationDraggingDidEnd: function(t) {
                this._draggedAnnotation && (this._annotationDraggingMapPanningController.stop(), this._draggedAnnotation._impl.dropAfterDraggingAndRevertPosition(!t), y.classList.remove(this._draggedAnnotation._impl.node.element, L.LIFTED), y.classList.remove(this._node.element, L.DRAGGING), this._map.annotationDraggingDidEnd(), this._map.dispatchEventWithAnnotation(d.Events.DragEnd, this._draggedAnnotation), delete this._draggedAnnotation, this._updateSceneGraph())
            },
            annotationPropertyDidChange: function(t, e) {
                ...
                this._updateVisibleAnnotations([t]), this._updateLabelRegionForAnnotation(t)
            },
            ...
            _addAnnotationWaitingForTiles: function(t, e, i) {
                ...
                }) ? !i && t._impl.doesAnimate() && t._impl.delayMs > 0 ? t._impl.timeout = window.setTimeout(this._addAnnotationToMap.bind(this, t), t._impl.delayMs) : this._addAnnotationToMap(t, i) : this._waitingAnnotations ? this._waitingAnnotations.push(t) : (this._waitingAnnotations = [t], this._tileLoadingTimeout = window.setTimeout(this.addWaitingAnnotations.bind(this, v.noop), 3e3))
            },
            _didDeselectAnnotation: function(t) {
                y.classList.remove(t._impl.node.element, L.SELECTED), this.selectedItem = null, this._map.annotationSelectionDidChange(t), this._hideCallout(t)
            },
            _didSelectAnnotation: function(t) {
                y.classList.add(t._impl.node.element, L.SELECTED), this.selectedItem = t, this._map.annotationSelectionDidChange(t), t._impl.visible && this._showCalloutForAnnotation(t)
            },
            ...
            _totalMapNudgingTranslation: function(t, e, i) {
                ...
                return t = o(t, n.x, n.y), s.forEach(function(e) {
                    if (t.minX() < e.maxX() && t.maxX() > e.minX() && t.minY() < e.maxY() && t.maxY() > e.minY()) {
                        if (l += t.minX() < a ? t.minX() - e.maxX() : t.maxX() - e.minX(), h += t.minY() < r ? t.minY() - e.maxY() : t.maxY() - e.minY(), i) return;
                        0 !== h && Math.abs(l) > Math.abs(h) ? l = 0 : h = 0, t = o(t, l, h)
                    }
                }, this), n.x += l, n.y += h, n
            },
            _hideCallout: function(t) {
                this._callout && (t._impl.calloutWillDisappear(), y.classList.remove(this._callout.node.element, L.SELECTED), this._callout.animateOut(), delete this._callout)
            },
            ...
            _showCalloutForAnnotation: function(t, e) {
                if (this._hideCallout(t), t._impl.canShowCallout()) {
                    ...
                    if (!i || "function" != typeof i.calloutShouldAppearForAnnotation || i.calloutShouldAppearForAnnotation(t)) {
                        var n;
                        if (i && "function" == typeof i.calloutElementForAnnotation && (n = i.calloutElementForAnnotation(t), v.checkElement(n, "[MapKit] calloutElementForAnnotation() must return a DOM element, but returned `" + n + "` instead.")), !n) {
                            var o;
                            if (i && "function" == typeof i.calloutContentForAnnotation && (o = i.calloutContentForAnnotation(t), v.checkElement(o, "[MapKit] contentElementForAnnotation() must return a DOM element, but returned `" + o + "` instead.")), !o && !t.title) return
                        }
                        t._impl.calloutWillAppear();
                        var s;
                        i && "function" == typeof i.calloutLeftAccessoryForAnnotation && (s = i.calloutLeftAccessoryForAnnotation(t), v.checkElement(s, "[MapKit] calloutLeftAccessoryForAnnotation() must return a DOM element, but returned `" + s + "` instead.")), !s && t._impl.canvasForCalloutAccessory && (s = t._impl.canvasForCalloutAccessory());
                        var a;
                        i && "function" == typeof i.calloutRightAccessoryForAnnotation && (a = i.calloutRightAccessoryForAnnotation(t), v.checkElement(a, "[MapKit] calloutRightAccessoryForAnnotation() must return a DOM element, but returned `" + a + "` instead.")), this._callout = new p(this._styleHelper, {
                            customElement: n,
                            contentElement: o,
                            ignoreCalloutCornerRadiusForLeftAccessory: t._impl.ignoreCalloutCornerRadiusForLeftAccessory,
                        ...
                        var r = this._callout.animates && i && "function" == typeof i.calloutAppearanceAnimationForAnnotation ? i.calloutAppearanceAnimationForAnnotation(t) : "";
                        if (v.checkType(r, "string", "[MapKit] calloutAppearanceAnimationForAnnotation() must return a string, but returned `" + r + "` instead."), this._callout.appearanceAnimation = r, n) {
                            var l;
                            i && "function" == typeof i.calloutAnchorOffsetForAnnotation && (l = i.calloutAnchorOffsetForAnnotation(t, this._callout.node.size), v.checkInstance(l, window.DOMPoint, "[MapKit] calloutAnchorOffsetForAnnotation() must return a DOMPoint, but returned `" + l + "` instead.")), this._callout.setAnchorOffset(l)
                        }
                        this._updateCalloutInfo(t), this._updateCalloutPositionWithTailShift(t, !1);
                        var h = !e && this._nudgeMapToShowCallout();
                        this._callout.willMoveToMap(), y.classList.add(this._callout.node.element, L.SELECTED), this._calloutsNode.addChild(this._callout.node), h || this._callout.animateIn()
                    }
                }
            },
            mapWasDestroyed: function() {
            ...
            _updateCalloutInfo: function(t) {
                this._callout ? this._callout.updateInfo(t) || this._hideCallout(t) : this._showCalloutForAnnotation(t)
            },
            ...
            _updateVisibleAnnotations: function(t, e) {
                ...
                t.forEach(function(t) {
                    if (t !== this._draggedAnnotation || !this._annotationDraggingMapPanningController.panning) {
                        ...
                        t._impl.setPosition(i.adjustMapItemPoint(i.camera.transformMapPoint(new w(e, t._impl.y))))
                    }
            ...
            _updateCollisions: function(t) {
                var e = !1,
                    i = this._items.filter(function(i) {
                        var n = i.visible && i._impl.isShown(),
                            o = (n || i._impl.needsColliding) && this.isItemExposed(i);
                        return delete i._impl.needsColliding, o && i.displayPriority < u.DisplayPriority.Required && t.indexOf(i) >= 0 && (e = !0), o && n
                    }, this);
                e && this._clustersController.collideAnnotations(i)
            },
            addCluster: function(t) {
                var e = t;
                try {
                    "function" == typeof this._map.annotationForCluster && (e = this._map._annotationForCluster.call(this._map.public, t)), this._clustersController.setRequiredClusterAnnotationProperties(e, t), this.addItem(e)
                } catch (i) {
                    console.warn("[MapKit] annotationForCluster: the following error occurred; reverting to default annotation: " + i), e = this.addItem(t)
                }
                return e._impl.customCluster = e !== t, e
            },
            updatedCollisions: function() {
                this._items.forEach(function(t) {
                    t._impl.updateVisibility(t._impl.occluded)
        ...
        var T = y.debounce(function(t, e, i) {
        ...
        "../../../lib/geo": 2,
        "../layer-items-controller": 178,
        "../services/geocoder": 211,
        "../style-helper": 218,
        "../utils": 223,
        "./annotation": 125,
        "./annotation-dragging-map-panning-controller": 121,
        "./annotation-internal": 122,
        "./annotations-controller-node": 126,
        "./callout": 128,
        "./clusters-controller": 131,
        "./user-location-annotation": 154,
        "@maps/geometry/point": 69,
        "@maps/geometry/rect": 70,
        "@maps/js-utils": 84,
        "@maps/render-tree": 100,
    ...
    128: [function(t, e, i) {
        function n(t, e) {
            ...
            function n(t, e) {
                var i = p.htmlElement("div", {
                    class: I.CALLOUT_ACCESSORY_CONTENT
                }, t);
                return i.style.maxWidth = T / 2 + "px", e && (i.style.padding = "0"), p.htmlElement("div", {
                    class: I.CALLOUT_ACCESSORY
                }, i)
            }
            r.call(this, this), this._impl = this, this._styleHelper = t, this._rtl = e.rtl;
            var o = p.htmlElement("div", {
                class: I.CALLOUT
            });
            this._node = new u.Node(o), e.customElement ? (this._containerElement = this._customElement = o.appendChild(e.customElement), this.setSize(this._styleHelper.sizeForElement(this._customElement))) : (this._ignoreCalloutCornerRadiusForLeftAccessory = e.ignoreCalloutCornerRadiusForLeftAccessory, this._tailSide = e.tailSide || _.Bottom, this._tailScale = e.tailScale || 1, this._bubbleElement = p.svgElement("path"), this._svgElement = o.appendChild(p.svgElement("svg", {
                class: I.CALLOUT_BUBBLE
            }, this._bubbleElement)), this._containerElement = o.appendChild(p.htmlElement("div")), e.leftAccessory && (this._leftAccessoryBackgroundColor = i(e.leftAccessory), this._leftAccessory = n(e.leftAccessory, !this._rtl && this._ignoreCalloutCornerRadiusForLeftAccessory), this._containerElement.appendChild(this._leftAccessory)), this._containerContentElement = this._containerElement.appendChild(p.htmlElement("div", {
                class: I.CALLOUT_CONTENT
            })), e.rightAccessory && (this._rightAccessoryBackgroundColor = i(e.rightAccessory), this._rightAccessory = n(e.rightAccessory, this._rtl && this._ignoreCalloutCornerRadiusForLeftAccessory), this._containerElement.appendChild(this._rightAccessory)), (this._leftAccessoryBackgroundColor || this._rightAccessoryBackgroundColor) && (this._calloutId = a(), this._linearGradientElement = p.svgElement("linearGradient", {
                id: this._calloutId
        ...
        n.prototype = m.inheritPrototype(r, n, {
            ...
            updateInfo: function(t) {
                ...
                this._containerContentElement.innerHTML = "", this._containerElement.style.width = "", this._containerContentElement.appendChild(p.htmlElement("div", {
                    class: I.TITLE
                }, t.title)), t.subtitle ? (this._containerContentElement.appendChild(p.htmlElement("div", {
                    class: I.SUBTITLE
                }, t.subtitle)), p.classList.remove(this._containerElement, I.NO_SUBTITLE)) : (p.classList.add(this._containerElement, I.NO_SUBTITLE), this._containerElement.classList.toggle(I.NO_ACESSORIES, !this._leftAccessory && !this._rightAccessory)), this._updateAccessoryViews();
                var e = this._styleHelper.sizeForElement(this._containerElement);
                return e.width = m.clamp(e.width, L, T), this._updateSize(e, {
                    annotation: t
            ...
            _updateSize: function(t, e) {
                ...
                var l = i ? k.withIcon.left + k.withIcon.right : k.default.left + k.default.right - k.default.content.left;
    ...
    129: [function(t, e, i) {
        ...
        n.prototype = a.inheritPrototype(s, n, {
            ...
            get subtitle() {
                var t = this.n - 1;
                return this.hasOwnProperty("_subtitle") ? this._subtitle : r.get("Annotation.Clustering.More" + (t > 1 ? ".Plural" : ""), {
                    n: r.digits(t)
                })
            },
            set subtitle(t) {
        ...
        "../localizer": 180,
        "./annotation-internal": 122,
        "./marker-annotation-internal": 140,
        "@maps/js-utils": 84
    }],
    130: [function(t, e, i) {
        function n(t, e, i) {
        ...
        "./cluster-annotation-internal": 129,
        "./marker-annotation": 144,
        "@maps/js-utils": 84
    }],
    131: [function(t, e, i) {
        function n(t) {
            this._annotationsController = t, this._clusters = [], this._previousClusters = []
        }
        ...
        function o(t) {
            for (var e = [], i = t.length, n = 0; n < i; ++n) {
                ...
                if (!o._impl.occluded)
                    for (var a = n + 1; a < i; ++a) {
                        var r = t[a];
                        if (c(o, r) && (r._impl.occluded = !0, !h(o) && o.clusteringIdentifier && o.clusteringIdentifier === r.clusteringIdentifier && (!o._impl.cluster || !r._impl.cluster))) {
                            var l = s(o, r);
                            l && e.push(l)
                        }
                    }
        ...
        function s(t, e) {
            if (t._impl.pseudocluster) e._impl.pseudocluster || (t._impl.pseudocluster.push(e), e._impl.pseudocluster = t._impl.pseudocluster);
            else {
                if (!e._impl.pseudocluster) {
                    var i = [t, e];
                    return t._impl.pseudocluster = i, e._impl.pseudocluster = i, i
                }
                e._impl.pseudocluster.push(t), t._impl.pseudocluster = e._impl.pseudocluster
            }
        }
        ...
        function l(t, e) {
            var i = t.selected ? 1 / 0 : t.displayPriority;
            return (e.selected ? 1 / 0 : e.displayPriority) - i || e._impl.y - t._impl.y
        }

        function h(t) {
            return t.selected || t.displayPriority === g.DisplayPriority.Required
        }

        function c(t, e) {
            return !(t.memberAnnotations && t.memberAnnotations.indexOf(e) >= 0) && ((!h(t) || !h(e)) && p(t._impl.boundingBox, e._impl.boundingBox))
        }
        ...
        function u(t) {
            ...
            return t.collisionMode === g.CollisionMode.Circle && (a.cx = (a.x1 + a.x2) / 2, a.cy = (a.y1 + a.y2) / 2, a.r = Math.min(n, o) / 2), a
        }
        ...
        function p(t, e) {
            ...
            return !e.hasOwnProperty("r") || d(e, t)
        }

        function m(t) {
            for (var e = [], i = t; i.length > 0;) {
                var n = i.shift();
                delete n._impl.pseudocluster, n._impl.occluded = !0, n.memberAnnotations ? i = n.memberAnnotations.concat(i) : e.push(n)
            }
            return e
        }
        var g = t("./annotation"),
            ...
            v = 5;
        n.prototype = {
            collideAnnotations: function(t) {
                this._scheduledCollideAnnotations || (this._scheduledCollideAnnotations = window.setTimeout(this._collideAnnotations.bind(this), 0)), this._annotations = t
            },
            setRequiredClusterAnnotationProperties: function(t, e) {
                t !== e && (t.coordinate = e.coordinate, t.draggable = !1, t.displayPriority = e.memberAnnotations[0].displayPriority, t.clusteringIdentifier = e.memberAnnotations[0].clusteringIdentifier, Object.defineProperty(t, "memberAnnotations", {
                    enumerable: !0,
            ...
            _collideAnnotations: function() {
                this._clusters.forEach(function(t) {
                    t._impl.occluded = !0
                }), this._annotations.forEach(function(t) {
                    t._impl.boundingBox = u(t), t._impl.occluded = !1
                });
                var t = this._annotations.sort(l);
                delete this._annotations, this._clusters = o(t).map(function(t) {
                    var e = t.sort(l);
                    return e.forEach(function(t) {
                        t._impl.occluded = !0, delete t._impl.pseudocluster
                    }), this._clusterAnnotationForMemberAnnotations(e)
                }, this), (t = t.filter(function(t) {
                    return !t._impl.occluded
                }).concat(this._clusters).sort(l)).forEach(function(t) {
                    t._impl.boundingBox = u(t)
                }), this._clusters = this._clusters.concat(o(t).map(function(t) {
                    var e = m(t).sort(l);
                    return this._clusterAnnotationForMemberAnnotations(e)
                }, this)).filter(function(t) {
                    return !t._impl.occluded
                }), delete this._scheduledCollideAnnotations, this._annotationsController.updatedCollisions()
            },
            _clusterAnnotationForMemberAnnotations: function(t) {
                var e, i = r(this._previousClusters, t);
                if (i >= 0)(e = this._previousClusters[i])._impl.occluded = !1;
                else {
                    var n = a(t);
    ...
    132: [function(t, e, i) {
        ...
        n.prototype = h.inheritPrototype(o, n, {
            ...
            set url(t) {
                ...
                this._url = t;
                var e = this._sceneGraphNode.image = l.htmlElement("img", {
                    src: this._url[this._ratio]
                });
            ...
            _handleImageError: function() {
                ...
                }, this._sceneGraphNode.image = l.htmlElement("img", {
                    src: m
                }), this._setElementSize(g)
            },
        ...
        "../utils": 223,
        "./annotation-internal": 122,
        "./image-annotation-node": 133,
        "./pin-annotation-internal": 146,
        "@maps/css-matrix": 58,
        "@maps/geometry/point": 69,
        "@maps/geometry/size": 71,
        "@maps/js-utils": 84
    ...
    135: [function(t, e, i) {
        ...
        "../../../lib/scene-graph": 47,
        "./marker-annotation-balloon-renderer": 136,
        "@maps/js-utils": 84
    }],
    136: [function(t, e, i) {
        function n(t) {
        ...
        function o(t, e, i) {
            t.save(), t.textAlign = "center", t.textBaseline = "bottom", t.fillStyle = e.glyphColor;
            var n, o = i.glyphFontSize;
            do {
                t.font = o-- + "px " + h.MarkerAnnotationFontFamily, n = t.measureText(e.glyphText).width
            } while (n > i.glyphImageSize && o > 0);
            var s = o + i.balloonRadius - o / 2 + 1;
            return t.fillText(e.glyphText, i.balloonRadius, s, i.glyphImageSize), t.restore(), o + 1
        }
        ...
        function s(t, e, i, n) {
            ...
            if (!(s = "default" === i || "lifted" === i ? e.glyphImage : e.selectedGlyphImage || e.glyphImage)) {
                if (v) return e.annotation.glyphText = "?", o(t, e.annotation, n), null;
                s = l[e.bubble ? "bubble" : i], c = !0, 1 === g && "default" === i && (t.imageSmoothingEnabled = !1)
            }
            try {
        ...
        var l, h = t("../constants"),
            ...
            g = Math.min(d.devicePixelRatio, 3),
            _ = p.createImageUrl("pins/marker"),
            f = (g > 1 ? "_" + g + "x" : "") + ".png",
            y = [],
            v = !1;
        n.prototype = u.inheritPrototype(c.RenderItem, n, {
                draw: function(t) {
                    ...
                    } else y.indexOf(this._node) < 0 && y.push(this._node)
                }
            }),
            function() {
                function t() {
                    0 === --o && (l = n, y.forEach(function(t) {
                        t.needsDisplay = !0
                    }))
                }

                function e(e) {
                    console.warn("[MapKit] Error loading marker annotation image " + e.target.src + "; marker annotations may not display correctly."), v = !0, t()
                }
                ...
                function i(i) {
                    ...
                    s.addEventListener("error", e), s.addEventListener("load", function() {
                        n[i] = s, t()
                    }), s.addEventListener("error", e)
                }
                var n = {},
                    o = ["default", "selected", "bubble"].reduce(function(t, e) {
                        return n[e] = {}, i(e), t + 1
                    }, 0)
            }(), e.exports = n
    }, {
    ...
    138: [function(t, e, i) {
        ...
        "../../../lib/scene-graph": 47,
        "./marker-annotation-dot-renderer": 139,
        "@maps/js-utils": 84
    }],
    139: [function(t, e, i) {
        function n(t) {
    ...
    140: [function(t, e, i) {
        function n(t, e, i) {
            this._sceneGraphNode = new r(this), s.call(this, t, e, s.div, i), this._public = t, i && p.forEach(function(t) {
                t in i && (this[t] = i[t])
        ...
        n.prototype = c.inheritPrototype(s, n, {
            ...
            updateLayout: function() {
                this._sceneGraphNode.needsLayout = !0
            },
            ...
            isAKnownOption: function(t) {
                return p.indexOf(t) >= 0 || s.prototype.isAKnownOption.call(this, t)
            },
            resetNodeTransform: function() {
            ...
            _setGlyphImage: function(t, e, i) {
                ...
                var n = a.bestRatio(i),
                    s = t + "Element";
                n ? o(this, i[n], s, e) : (delete this[s], this._sceneGraphNode.glyphImageError())
            },
            _updatedProperty: function(t) {
        ...
        "./annotation-internal": 122,
        "./image-annotation-internal": 132,
        "./marker-annotation-callout-bubble-node": 137,
        "./marker-annotation-node": 143,
        "@maps/css-matrix": 58,
        "@maps/js-utils": 84,
        "@maps/loaders": 85
    }],
    141: [function(t, e, i) {
        ...
        "../../../lib/scene-graph": 47,
        "./marker-annotation-label-renderer": 142,
        "@maps/js-utils": 84
    }],
    142: [function(t, e, i) {
        function n(t) {
        ...
        n.prototype = a.inheritPrototype(s.RenderItem, n, {
            ...
            draw: function(t) {
                var e = this._node,
                    i = this.params[e.kind];
                t.font = i.font, t.textAlign = this.params.textAlign, t.fillStyle = i.color, t.strokeStyle = this.params.haloColor, t.lineWidth = this.params.haloSize, t.miterLimit = this.params.miterLimit;
                var n = e.size.width / 2,
                    o = e.size.height + i.yPadding;
                t.strokeText(e.text, n, o), t.fillText(e.text, n, o)
            }
        }), e.exports = n
    }, {
        "../../../lib/scene-graph": 47,
    ...
    143: [function(t, e, i) {
        function n(t) {
            h.GroupNode.call(this), this.annotation = t, this._balloon = this.addChild(new w(t))
        }

        function o(t, e, i) {
            S.font = e;
            for (var n = t.trim().split(/\s+/), o = []; n.length > 0;) {
                for (var s = [n.shift()], a = S.measureText(s.join(" ")).width, r = 0; n.length > 0 && a < i;) s.push(n.shift()), r = a, a = S.measureText(s.join(" ")).width;
        ...
        var h = t("../../../lib/scene-graph"),
            ...
            p = t("@maps/geometry/size"),
            m = t("@maps/css-matrix"),
            g = t("../constants").FeatureVisibility,
            _ = {
                labelWidth: 64,
                shadowBlur: 3,
            ...
            w = t("./marker-annotation-balloon-node"),
            b = t("./marker-annotation-dot-node"),
            C = t("./marker-annotation-label-node");
        n.prototype = c.inheritPrototype(h.BaseNode, n, {
            ...
            balloonNodeSize: function(t) {
                t || (t = this.state);
                var e = this.params[t];
                if ("callout" === t) return new p(2 * e.radius, 2 * e.radius);
                var i = 2 * e.balloonRadius;
                return new p(i, i + e.tailLength + e.offset)
            },
            updateState: function(t) {
                var e = this.annotation;
                t = t || (e.selected ? "selected" : "default"), this.state !== t && ((e.selected || "selected" === this.state || "callout" === this.state) && (this._animateFromState = this._animateFromState || this.state), this.state = t, e._node.size = this._size = this._balloon.size = this.balloonNodeSize(), this.needsLayout = !0)
            },
            performScheduledUpdate: function() {
                this._needsLayout && (this._layoutSubNodes(), this._needsLayout = !1)
            },
            ...
            _layoutSubNodes: function() {
                function t(t, e) {
                    i.forEach(function(e) {
                        e.kind === t && (this.addChild(e), r(e, u, this.annotation))
                    }, this), delete this[e]
                }
                ...
                function e(t, e) {
                    var i = C.Font[t],
                        s = u.labelWidth,
                        r = h[t],
                        l = !(!this.parent || r === e || r && e);
                    return o(r, i, s).forEach(function(e) {
                        var i = new C(e[0], t);
                        i.size = new p(e[1], i.lineHeight), n = Math.max(n, e[1]), v = i.lineHeight / 2, this.addChild(i), l && a(i, u)
                    }, this), r
                }
                if (this.annotation) {
                    var i = this.children.slice();
                    this.children = [this._balloon], this._dot && this.addChild(this._dot);
                    var n = this._balloon.size.width,
                        h = this.annotation,
                        c = this.state,
                        u = this.params[this.state],
                        g = "callout" !== c && "lifted" !== c && h.labelsCanBeShown(),
                        _ = g && h.titleCanBeShown();
                    _ ? this._prevTitle = e.call(this, "title", this._prevTitle) : t.call(this, "title", "_prevTitle"), g && h.subtitleCanBeShown(_) ? this._prevSubtitle = e.call(this, "subtitle", this._prevSubtitle) : t.call(this, "subtitle", "_prevSubtitle");
                    var f = this._balloon.size.height,
                        y = f,
                        v = 0;
                    if (this.children.forEach(function(t) {
                            t.position = new d((n - t.size.width) / 2, t.lineHeight ? y : 0), t.lineHeight && (y += t.lineHeight, t.fadingOut || (f += t.lineHeight, v = t.lineHeight / 2))
                        }), h._anchorPoint = new d(n / 2, this._balloon.size.height), h._node.size = this.size = new p(n, f + v), h.updatePosition(), "selected" === this.state ? (this._dot || (this._dot = this.addChild(new b(this.annotation, u.dotRadius * u.dotScale))), this._dot.size = new p(2 * u.dotRadius * u.dotScale, 2 * u.dotRadius * u.dotScale), this._dot.position = new d(this._balloon.position.x + u.balloonRadius - u.dotRadius, this._balloon.size.height - 2 * u.dotRadius), this._dot.transform = (new m).scale(1 / u.dotScale), this._dot.wantsLayerBacking = !0) : this._dot && (this._dot.remove(), delete this._dot), this.hasOwnProperty("_animateFromState")) {
                        if ("callout" === this.state || "callout" === this._animateFromState) {
                            var S = s(u);
                            S.transitionDuration /= 2;
                            var L = this.addChild(new w(this.annotation, this._animateFromState));
                            L.glyphImage = this._balloon.glyphImage, L.selectedGlyphImage = this._balloon.selectedGlyphImage, L.size = this.balloonNodeSize(L.state), L.position = new d((this.size.width - L.size.width) / 2, this._balloon.size.height - L.size.height), this._balloon.transform = (new m).scale(1e-12), l(L, S, 1, 1e-12, 0, function() {
                                L.remove(), l(this._balloon, u, 1e-12, 1, u.springMass)
                            }.bind(this))
                        } else {
                            var E = this.balloonNodeSize(this._animateFromState).height / this.balloonNodeSize().height;
                            1 !== E && l(this._balloon, u, E, 1, u.springMass);
                            var T = this._dot;
                            T && a(T, {
                                transitionDuration: u.dotAnimationDuration
                            })
                        }
        ...
        }), n.FeatureVisibility = g;
        var S = document.createElement("canvas").getContext("2d");
        e.exports = n
    }, {
        "../../../lib/scene-graph": 47,
        "../constants": 159,
        "./marker-annotation-balloon-node": 135,
        "./marker-annotation-dot-node": 138,
        "./marker-annotation-label-node": 141,
        "@maps/css-matrix": 58,
        "@maps/geometry/point": 69,
        "@maps/geometry/size": 71,
        "@maps/js-utils": 84,
    ...
    146: [function(t, e, i) {
        ...
        "../localizer": 180,
        "./annotation-internal": 122,
        "./pin-annotation-animation-controller": 145,
        "./pin-annotation-node": 147,
        "@maps/css-matrix": 58,
        "@maps/geometry/point": 69,
        "@maps/geometry/size": 71,
        "@maps/js-utils": 84
    ...
    149: [function(t, e, i) {
        function n(t, e) {
            console.warn("[MapKit] mapkit.PinAnnotation is deprecated and will be removed in a future release. Please use the newer mapkit.MarkerAnnotation class instead."), Object.defineProperty(this, "_impl", {
                value: new s(this, t, e)
            })
        }
        var o = t("./annotation"),
    ...
    150: [function(t, e, i) {
        ...
        "../localizer": 180,
        "./annotation-internal": 122,
        "./user-location-annotation-node": 151,
        "./user-location-annotation-style": 153,
        "@maps/js-utils": 84
    }],
    151: [function(t, e, i) {
        function n(t) {
        ...
        "../../../lib/scene-graph": 47,
        "./user-location-annotation-renderer": 152,
        "@maps/js-utils": 84,
        "@maps/scheduler": 104
    }],
    152: [function(t, e, i) {
    ...
    154: [function(t, e, i) {
        ...
        "./annotation": 125,
        "./user-location-annotation-internal": 150,
        "@maps/js-utils": 84
    }],
    155: [function(t, e, i) {
        "use strict";
    ...
    161: [function(t, e, i) {
        function n(t) {
            _.call(this, o.htmlElement("div", {
                class: C
            })), this._map = t, this._logo = this.addChild(new a), this._topLeftControlsNode = this.addChild(new _(o.htmlElement("div", {
                class: S
            }))), this._topRightControlsNode = this.addChild(new _(o.htmlElement("div", {
                class: E
            }))), this._bottomRightControlsNode = this.addChild(new _(o.htmlElement("div", {
                class: L
            }))), this._legalControl = this._topRightControlsNode.addChild(new r), this._controlsPending = !1, y.activeLocale && (this._rtl = y.activeLocale.rtl), y.addEventListener(y.Events.LocaleChanged, this)
        }
        var o = t("../utils"),
            s = t("@maps/js-utils"),
            a = t("./logo"),
            ...
            E = "mk-top-right-controls-container",
            T = new p(7, 11);
        n.prototype = s.inheritPrototype(_, n, {
            ...
            _positionScale: function() {
                var t = this._map.ensureVisibleFrame().size,
                    e = !this._rtl;
                this._scale.node.leftAligned = e, this._scale.position = e ? new p(T.x, T.y) : new p(t.width - this._scale.size.width - T.x, T.y), this._scale.shouldDisplayScale || this._scale.node.setOpacityAnimated(0, !1)
            },
        ...
        "../localizer": 180,
        "../map": 183,
        "../user-location/user-location": 222,
        "../utils": 223,
        "./legal-control": 162,
        "./logo": 163,
        "./map-type-control": 164,
        "./rotation-control": 165,
        "./scale": 166,
        "./user-location-control": 167,
        "./zoom-control": 168,
        "@maps/geometry/point": 69,
        "@maps/geometry/rect": 70,
        "@maps/geometry/size": 71,
    ...
    162: [function(t, e, i) {
        function n() {
            ...
            var i = e.appendChild(h.htmlElement("div", {
                class: y.LEGAL_INFO_CONTAINER
            }));
        ...
        function s(t, e, i) {
            var n, o, s = a(t);
            return h.classList.add(s, y.LEGAL_ATTRIBUTION_ITEM), i ? (n = '<img width="68" height="22" class="mk-attribution-logo" src="' + h.imagePathForDevice([1, 2, 3], g.createImageUrl("legal/tomtom")) + '" alt="TomTom">', o = h.htmlElement("span", {
                class: "mk-right-caret"
            }, l()), s.innerHTML = m.get("Legal.Attribution.HTML.Label", {
                logo: n,
                chevron: o.outerHTML
            })) : s.textContent = m.get("Legal.Attribution.Plain.Label", {
                attribution: e
            }), s
        }
        ...
        function r() {
            return h.createSVGIcon(h.svgElement("path", {
        ...
        var f = new _(222, 116),
            ...
            v = {
                MAP_ATTRIBUTION_URL: "data-map-attribution-url"
            };
        n.prototype = c.inheritPrototype(d, n, {
            ...
            updateLegalInfo: function(t) {
                ...
                e.forEach(function(t, i) {
                    this._elInfoItems.appendChild(t), i < e.length - 1 && this._elInfoItems.appendChild(h.htmlElement("div", {
                        class: y.DIVIDER
                    }))
                }, this)
            },
            ...
            _open: function() {
                window.addEventListener(h.touchstartOrMousedown, this, !0), this._legalInfoNode.element.addEventListener("transitionend", this), h.classList.add(this._legalInfoNode.element, y.OPEN), this._isOpen = !0, c.isIE9() && this._handleTransitionend()
            },
            _close: function() {
                this._isOpen = !1, this._updateAccessibilityState(), window.removeEventListener(h.touchstartOrMousedown, this, !0), h.classList.remove(this._legalInfoNode.element, y.OPEN), c.isIE9() && this._handleTransitionend()
            },
            _tabbable: function() {
    ...
    163: [function(t, e, i) {
        function n() {
            this._logoElement = o.htmlElement("img", {
                class: u.LOGO
            }), l.call(this, o.htmlElement("div", {
                class: u.CONTROL
            }, this._logoElement)), h.addEventListener(h.Events.LocaleChanged, this)
        }
        var o = t("../utils"),
            s = t("@maps/js-utils"),
            a = t("../configuration"),
    ...
    164: [function(t, e, i) {
        function n(t, e, i) {
            c.call(this, l.htmlElement("div", {
                class: g.CONTROL
            })), u.EventTarget(this), this._caretIcon = o(), this._checkmarkIcon = s(), ["Standard", "Hybrid", "Satellite"].forEach(function(i) {
                var n = new d.Node(l.htmlElement("div", {
                        class: g.MAP_TYPE
                    })),
                    o = "Mode." + i;
        ...
        function o() {
            return l.createSVGIcon(l.svgElement("path", {
        ...
        function s() {
            return l.createSVGIcon(l.svgElement("path", {
                d: "M3.76776695,8.47487373 L3.41421356,8.82842712 L2.70710678,8.12132034 L0.707106781,6.12132034 L0,5.41421356 L1.41421356,4 L2.12132034,4.70710678 L3.41421356,6 L8.70710678,0.707106781 L9.41421356,0 L10.8284271,1.41421356 L10.1213203,2.12132034 L4.12132034,8.12132034 L3.76776695,8.47487373 Z"
            }), {
                viewBox: "0 0 11 9"
            })
        }
        ...
        n.EVENTS = {
            ...
            _open: function() {
                this._isOpen || (window.addEventListener(l.touchstartOrMousedown, this, !0), this._isOpen = !0, this._openTime = Date.now(), this._transitioning = !0, l.classList.add(this.element, g.OPEN), this._updateActiveIcon(), h.isIE9() ? this._handleTransitionend() : l.classList.add(this.element, g.OPENING), this._delegate.mapTypeControlWasOpened())
            },
            _close: function() {
                this._isOpen && (window.removeEventListener(l.touchstartOrMousedown, this, !0), delete this._isOpen, delete this._isDown, delete this._openTime, this._transitioning = !0, l.classList.remove(this.element, g.OPEN), this._updateActiveIcon(), h.isIE9() && this._handleTransitionend(), this._clearOutline(), this._delegate.mapTypeControlWasClosed())
            },
            _updateDisplay: function() {
                this.localeChanged();
    ...
    165: [function(t, e, i) {
        function n(t) {
            ...
            var e = l.htmlElement("img", {
                class: f.COMPASS,
                role: "presentation"
            });
            e.src = a(), this._compass = e, this._compassNode.element.appendChild(e);
            var i = l.htmlElement("div", {
                class: f.NORTH_INDICATOR
            });
        ...
        n.prototype = h.inheritPrototype(c, n, {
            ...
            reset: function(t) {
                this._map && this._center && this._map.compassDraggingDidEnd(), l.classList.remove(this.element, f.PRESSED), !t || t.target !== this._tapRecognizer && t.keyCode !== h.KeyCodes.UpArrow && t.keyCode !== h.KeyCodes.SpaceBar || this._map.setRotationAnimated(0, !0), delete this._angleOffset
            },
            ...
            _updateLabels: function(t) {
                this._northIndicator.textContent = p.get("Compass.NorthIndicator"), l.updateLabel(this.element, p.get("Compass.Tooltip"))
            },
            ...
            _beginDrag: function(t) {
                ...
                }, this._map.compassDraggingWillStart(), l.classList.add(this.element, f.PRESSED), this._angleOffset = o(t.target.locationInClient().x, t.target.locationInClient().y, this._center.x, this._center.y) - this._map.rotation
            },
            _drag: function(t) {
    ...
    167: [function(t, e, i) {
        ...
        n.States = {
            ...
            _addUpdatedErrorMessage: function() {
                this._showsErrorMessage = !0, this._updateErrorMessage(), this._positionErrorMessage(), this._animateErrorMessageIn(), l.isIE9() && (this._errorMessageElement.style.opacity = 1), this.parent.parent.addChild(this._errorMessageNode), window.addEventListener(a.touchstartOrMousedown, this, !0), window.addEventListener("keydown", this, !0)
            },
    ...
    168: [function(t, e, i) {
        function n() {
            ...
            this._zoomOutButton = t.appendChild(r.htmlElement("div", {
                ...
                role: "button",
                tabindex: "0"
            })), this._zoomOutButton.appendChild(a()), t.appendChild(r.htmlElement("div", {
                class: d.BUTTON_DIVIDER
            })), this._zoomInButton = t.appendChild(r.htmlElement("div", {
        ...
        function s() {
            ...
            return t.setAttribute("d", "M7,6 L7,1 L6,1 L6,6 L1,6 L1,7 L6,7 L6,12 L7,12 L7,7 L12,7 L12,6 L7,6 Z"), r.createSVGIcon(t, {
                viewBox: "0 0 13 13"
            })
        }

        function a() {
            var t = r.svgElement("rect", {
                x: 1,
                y: 6,
                width: 12,
                height: 1
            });
            return r.createSVGIcon(t, {
                viewBox: "0 0 13 13"
            })
        }
        var r = t("../utils"),
    ...
    173: [function(t, e, i) {
        ...
        var h = {
            ...
            PolylineOverlay: t("./overlays/polyline-overlay"),
        ...
        n.EventTarget(h), e.exports = h, document.head.appendChild(l.htmlElement("style", t("./css")))
    }, {
        "../../lib/geo": 2,
        "../../lib/map-node": 7,
        "../build.json": 109,
        "./annotations/annotation": 125,
        "./annotations/image-annotation": 134,
        "./annotations/marker-annotation": 144,
        "./annotations/pin-annotation": 149,
        "./configuration": 157,
        "./constants": 159,
        "./css": 170,
        "./debug": 171,
        "./import-geojson-method": 172,
        "./map": 183,
        "./overlays/circle-overlay": 188,
        "./overlays/polygon-overlay": 197,
        "./overlays/polyline-overlay": 200,
        "./overlays/style": 202,
        "./padding": 207,
        "./services/directions": 209,
        "./services/geocoder": 211,
        "./services/search": 214,
        "./utils": 223,
        "@maps/dom-events": 62,
    ...
    177: [function(t, e, i) {
        ...
        "../utils": 223,
        "./long-press-and-pan-gesture-recognizer": 176,
        "@maps/gesture-recognizers": 72
    }],
    178: [function(t, e, i) {
        function n(t) {
            ...
            for (var n = !!i.animate, s = i.padding || m, a = i.minimumSpan || p, l = 0, h = 0, d = 0, g = 0, _ = [], f = 0, y = e.length; f < y; ++f) {
                ...
                if (v.map === t.public) {
                    ...
                    if (w) {
                        ...
                        _.push(w)
                    } else l = Math.max(l, v._impl._anchorPoint.y), h = Math.max(h, v.size.width - v._impl._anchorPoint.x), d = Math.max(d, v.size.height - v._impl._anchorPoint.y), g = Math.max(g, v._impl._anchorPoint.x), _.push(new r(v._impl.x, v._impl.y, 0, 0))
                }
            }
    ...
    180: [function(t, e, i) {
        ...
        "../locales/en-US/strings.json": 224,
        "../locales/locales-map.json": 225,
        "../locales/primary-locales.json": 226,
        "../locales/region-to-script-map.json": 227,
        "../locales/rtl-locales.json": 228,
        "../locales/supported-locales.json": 229,
        "../locales/supported-tile-locales.json": 230,
        "./urls": 220,
        "@maps/js-utils": 84,
        "@maps/localizer": 93
    }],
    181: [function(t, e, i) {
        ...
        function s(t) {
            t.selected = !0, k.log(k.Events.AnnotationClick, {
                map: this
            })
        }
        var a = t("../../lib/geo"),
        ...
        n.MapTypes = D.MapTypes, n.prototype = {
            ...
            set mapType(t) {
                if (t !== this._mapType) {
                    ...
                    this._mapType = t, this._mapNodeController.handleMapConfigurationChange(), this.controlsLayer.update(), this._overlaysController.mapTypeWasSet(this._mapType), this.public.dispatchEvent(new T.Event(H.MAP_TYPE_CHANGE)), k.log(k.Events.MapTypeChange, {
                        map: this
                    })
                }
            },
            ...
            setVisibleMapRectAnimated: function(t, e, i) {
                ...
                return e = void 0 === e || !!e, this._setVisibleMapRect(t, e, i), delete this._delayedShowItems, this.public
            },
            get region() {
            ...
            set showsCompass(t) {
                c.checkValueIsInEnum(t, z) ? (this.isRotationEnabled || t !== z.Visible && t !== z.Adaptive || console.warn("[MapKit] The compass cannot be shown when `Map.isRotationEnabled` is false."), t !== this._showsCompass && (this._showsCompass = t, this.controlsLayer && this.controlsLayer.updateRotationControl())) : console.warn("[MapKit] value passed to `Map.showsCompass` setter must be part of the MapKit.FeatureVisibility enum.")
            },
            get usingCSR() {
                return !this._mapNodeController.usingSSR
            },
            setRotationAnimated: function(t, e, i) {
                if (this.isRotationAvailable || console.warn("[MapKit] Rotation is not available."), c.required(t, "[MapKit] Tried to set `Map.rotation` property to a non-existent value."), "number" == typeof t) {
                    if (e) {
                ...
                console.warn("[MapKit] Region passed to `Map.rotation` setter is not a Number.")
            },
            get center() {
            ...
            setCenterAnimated: function(t, e, i) {
                c.required(t, "[MapKit] Tried to set `Map.center` property to a non-existent value.").checkInstance(t, U, "[MapKit] Value passed to `Map.center` setter is not a Coordinate object.");
                var n = this.camera.copy();
                return n.center = t.toMapPoint(), this._mapNode.setCameraAnimated(n, e), i || (this.tracksUserLocation = !1), this.public
            },
            get overlays() {
            ...
            mapCanStartPanning: function(t) {
                return !(this.tracksUserLocation && this.cameraIsZooming || this._annotationsController.dragging || this._isInitialInteractionTargetInUIElement() || !this.public.dispatchEvent(new T.Event(H.SCROLL_START)))
            },
            ...
            mapDidStopPanning: function(t) {
                this._startStabilizationTimeoutIfNeeded(), h.classList.remove(this.rootNode.element, "mk-panning"), this.public.dispatchEvent(new T.Event(H.SCROLL_END))
            },
            mapCanStartZooming: function(t) {
                return !(this._isInitialInteractionTargetInUIElement() || !this.public.dispatchEvent(new T.Event(H.ZOOM_START)))
            },
            mapWillStartZooming: function(t, e, i) {
                this._stopStabilizationTimeout(), i && (this.tracksUserLocation = !1)
            },
            mapDidStopZooming: function(t) {
                this._startStabilizationTimeoutIfNeeded(), this.public.dispatchEvent(new T.Event(H.ZOOM_END)), k.log(k.Events.Zoom, {
                    map: this
                }), this.controlsLayer.scaleDidChange()
            },
            ...
            mapCameraChangesWillStart: function(t, e) {
                this._zoomLevelWhenCameraChangeStarted = this.zoomLevel, this.public.dispatchEvent(new T.Event(H.REGION_CHANGE_START))
            },
            mapCameraChangesDidEnd: function(t) {
                this._zoomLevelWhenCameraChangeStarted !== this.zoomLevel && this.controlsLayer.zoomLevelDidChange(), delete this._zoomLevelWhenCameraChangeStarted, this.public.dispatchEvent(new T.Event(H.REGION_CHANGE_END))
            },
            mapRotationWillStart: function(t) {
                this.public.dispatchEvent(new T.Event(H.ROTATION_START))
            },
            mapRotationDidChange: function(t) {
                this.controlsLayer.updateRotationControl()
            },
            mapRotationDidEnd: function(t) {
                this.public.dispatchEvent(new T.Event(H.ROTATION_END))
            },
            ...
            _configurationDidBecomeAvailable: function(t) {
                this._mapNodeController.configurationDidBecomeAvailable(t), this._initialMapLoad && (k.log(k.Events.MapsLoad, {
                    map: this
                }), this._initialMapLoad = !1), this.controlsLayer.update(), u.location && !this._defaultVisibleMapRectHasBeenOverriden && (this.region = new F(new U(u.location.lat, u.location.lng), V))
            },
            ...
            _updateRenderingFrameFromElement: function() {
                var t = this.rootNode.element,
                    e = t.offsetWidth,
                    i = t.offsetHeight;
                0 !== e && 0 !== i && this._updateRenderingFrameSize(new E(e, i))
            },
            ...
            _adjustedPaddingForMapSize: function(t) {
                var e = this.controlsLayer.legalControlExpandedSize,
                    i = new E(Math.min(e.width, t.width), Math.min(e.height, t.height)),
            ...
            didInsertNewMapNode: function(t) {
                t.delegate = this, this._updateMapRoot(t), window.setTimeout(function() {
                    this.public.dispatchEvent(new T.Event(H.MAP_NODE_CHANGE))
                }.bind(this), 0)
            },
            ...
            mapNodeReady: function(t) {
                window.setTimeout(function() {
                    var e = new T.Event(H.MAP_NODE_READY);
                    e.usingCSR = t, this.public.dispatchEvent(e), k.log(k.Events.MapNodeReady, {
                        map: this
                    })
            ...
            overlaySelectionDidChange: function(t) {
                ...
                var e = new T.Event(t.selected ? H.SELECT : H.DESELECT);
            ...
            _dispatchCompleteEvent: function() {
                this._mapNode.fullyRendered && this.public.dispatchEvent(new T.Event(H.COMPLETE))
            },
            _handleLocaleChange: function(t) {
            ...
            _devicePixelRatioDidChange: function(t) {
                this.controlsLayer.devicePixelRatioDidChange(t), this._mapNode.devicePixelRatioDidChange() || this._mapNodeController.handleRecreate()
            },
            ...
            _setupListeners: function() {
                u.state === u.States.READY && this._configurationDidBecomeAvailable(!0), u.addEventListener(u.Events.Changed, this), _.activeLocale && this._handleLocaleChange({
                    locale: _.activeLocale
                }), _.addEventListener(_.Events.LocaleChanged, this), A.addEventListener("device-pixel-ratio-change", this), "function" == typeof window.matchMedia && (this._boundPrintListener = this._printMediaQueryChanged.bind(this), this._mediaQuery = window.matchMedia("print"), this._mediaQuery.addListener(this._boundPrintListener))
            },
        ...
        "./annotations/annotation": 125,
        "./annotations/annotations-controller": 127,
        "./collections/item-collection": 156,
        "./configuration": 157,
        "./constants": 159,
        "./controls/controls-layer": 161,
        "./controls/zoom-control": 168,
        "./instruments": 174,
        "./interaction/linear-zoom-controller": 175,
        "./interaction/map-user-interaction-controller": 177,
        "./layer-items-controller": 178,
        "./localizer": 180,
        "./map-node-controller": 182,
        "./overlays/overlay": 192,
        "./overlays/overlays-controller": 194,
        "./padding": 207,
        "./types-internal": 219,
        "./user-location/user-location-controller": 221,
        "./utils": 223,
        "@maps/device-pixel-ratio": 61,
        "@maps/dom-events": 62,
        "@maps/geometry/point": 69,
    ...
    182: [function(t, e, i) {
        ...
        function s(t) {
            if (h.supportsLocalStorage) return window.localStorage.getItem(t)
        }
        ...
        n.prototype = {
            ...
            get manageableMap() {
                var t = this._map.ensureRenderingFrame(),
                    e = this._gpuInfo.MAX_RENDERBUFFER_SIZE * _;
            ...
            get _cachedSpileResult() {
                var t = JSON.parse(s(g));
                if (t) return t[this.gpuKey]
            },
            ...
            handleSyrupError: function() {
                this._transition("syrup-error")
            },
            ...
            _enter_syrup_need_spile: function() {
                if (this.shouldDynamicallyLoadSyrup) return this.knownBadRendering ? (this.handleSyrupError(), void this._loadSpileIfNeeded(function(t) {
                    ...
                    t ? this.handleSpileLoad() : this.handleSyrupError()
                });
                this.handleSyrupError()
            },
            _enter_syrup_init: function() {
                if (!l.madabaDomains || !l.madabaDomains.length) return this._csrWarning(m.MissingMadaba), void this.handleSyrupError();
                ...
                var t = Spile.getRendererWithoutAnyWarranty(),
                    e = this.knownGoodRendering && this.manageableMap && !l.previewLoCSR;
                if (this.manageableMap || this.usingAdvancedAPIs || l.previewLoCSR) {
                    var i = this.node;
                    this._reConfigureMapNode(), i.init(l, t, Spile.Syrup.Camera, !e, function(t) {
                        t ? (this._csrWarning(m.SyrupInitFailure), this.handleSyrupError()) : (this._reConfigureMapNode(), i.needsDisplay = !0, this._map.didFinishMapNodeInitialization(i), this.handleSyrupComplete())
                    }.bind(this))
                } else this.handleSyrupError()
            },
            ...
            cacheSpileResult: function(t) {
                if (t.status !== Spile.Status.MAYBE && t["gpu-identifier"]) {
                    ...
                    }, a(g, JSON.stringify(n)), i || this.usingSSR || this.handleFallback()
                }
            },
    ...
    185: [function(t, e, i) {
        ...
        "../../../lib/geo": 2,
        "./circle-overlay-node": 186,
        "./styled-overlay-internal": 203,
        "@maps/js-utils": 84
    }],
    186: [function(t, e, i) {
        function n(t) {
        ...
        "./circle-overlay-renderer.js": 187,
        "./styled-overlay-node.js": 204,
        "@maps/js-utils": 84
    }],
    187: [function(t, e, i) {
        function n(t) {
        ...
        n.prototype = l.inheritPrototype(r, n, {
            ...
            drawClipped: function(t, e, i, n, r, l, c, u, d) {
                ...
                var E = Math.asin((y - b) / u);
                if (!isNaN(E)) {
                    var T = w + u * Math.cos(E);
                    T >= _ && T <= f && ((m = new s(T, y)).angle = (E + h) % h, C.push(m)), (T = w - u * Math.cos(E)) >= _ && T <= f && ((m = new s(T, y)).angle = Math.PI - E, C.push(m))
                }
                ...
                } else O > 0 && (t.fillStyle = e.fillColor, t.globalAlpha = e.fillOpacity, t.fillRect(0, 0, r.size.width * l.worldSize, r.size.height * l.worldSize));
                return !0
            }
        }), e.exports = n
    }, {
        "../../../lib/geo": 2,
        "./styled-overlay-renderer": 205,
        "@maps/geometry/point": 69,
        "@maps/js-utils": 84
    }],
    188: [function(t, e, i) {
    ...
    189: [function(t, e, i) {
        ...
        n.prototype = {
            ...
            fadeOverlayTo: function(t, e) {
                t.hasOwnProperty("fadeInOutOpacity") ? t.fadeInOutOpacity.durationMs = 350 * Math.abs(t.fadeInOutOpacity.value - t.fadeInOutOpacity.end) : (t.fadeInOutOpacity = {
                    durationMs: 350
                }, t.setFadeInOutOpacity(1 - e), this._overlays.push(t)), t.fadeInOutOpacity.start = t.fadeInOutOpacity.value, t.fadeInOutOpacity.end = e, t.fadeInOutOpacity.startTime = Date.now(), s.scheduleASAP(this)
            },
            performScheduledUpdate: function() {
                var t = Date.now();
    ...
    194: [function(t, e, i) {
        ...
        n.prototype = c.inheritPrototype(o, n, {
            ...
            mapTypeWasSet: function(e) {
                var i = t("../map");
                this._userLocationAccuracyRingOverlay && (this._userLocationAccuracyRingOverlay.style.fillOpacity = e === i.MapTypes.Standard ? .1 : .4)
            },
            ...
            updateUserLocationAccuracyRingOverlay: function(t) {
                if (t.coordinate) return this._userLocationAccuracyRingOverlay ? void this._userLocationAccuracyRingOverlay.updateForUserLocation(t) : (this._userLocationAccuracyRingOverlay = this.addItem(new l(t)), void this.mapTypeWasSet(this._map.mapType))
            },
            addedItem: function(t, e) {
        ...
        "../map": 183,
        "../utils": 223,
        "./accuracy-ring-overlay": 184,
        "./fade-animation-controller": 189,
        "./overlay": 192,
        "./overlays-controller-node": 193,
        "@maps/geometry/point": 69,
        "@maps/js-utils": 84,
        "@maps/scheduler": 104
    }],
    195: [function(t, e, i) {
        ...
        "../../../lib/geo": 2,
        "../line-simplification": 179,
        "../types-internal": 219,
        "./polygon-overlay-node": 196,
        "./styled-overlay-internal": 203,
        "@maps/js-utils": 84
    }],
    196: [function(t, e, i) {
    ...
    204: [function(t, e, i) {
        ...
        "./overlay-node.js": 191,
        "./styled-overlay-renderer.js": 205,
        "@maps/js-utils": 84
    }],
    205: [function(t, e, i) {
        function n(t) {
    ...
    208: [function(t, e, i) {
        ...
        function s(t, e, i) {
            this.name = t.name, this.distance = t.distanceMeters, this.expectedTravelTime = t.durationSeconds, this.transportType = t.transportType, this.path = t.stepIndexes.map(function(t) {
                return i[t]
        ...
        n.prototype = {
            ...
            _send: function(t, e, i, n) {
                ...
                var u = new c(r, {
                    ...
                    loaderDidFail: function(t, e) {
                        s.remove(t.id), i(new Error("Network error"))
                    }
    ...
    218: [function(t, e, i) {
        function n() {
            this._element = a.htmlElement("div", {
                class: r
            })
        }
    ...
    223: [function(t, e, i) {
        ...
        var o = t("@maps/device-pixel-ratio"),
            s = t("@maps/js-utils"),
            a = t("@maps/gesture-recognizers").SupportsTouches;
        e.exports = {
            ...
            touchstartOrMousedown: a ? "touchstart" : "mousedown",
            touchendOrMouseup: a ? "touchend" : "mouseup",
            supportsForceTouch: !a && "webkitForce" in MouseEvent.prototype,
            ...
            parentNodeForSvgTarget: function(t) {
                return s.isIE9() ? t.nearestViewportElement ? t.nearestViewportElement.parentNode : t.tagName && "div" !== t.tagName.toLowerCase() ? t.parentNode : t : t.tagName && "div" !== t.tagName.toLowerCase() ? this.parentNodeForSvgTarget(t.parentNode) : t
            },
